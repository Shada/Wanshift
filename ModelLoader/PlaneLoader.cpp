...
/*TEST(PlaneLoader, filePathTest)
{
	PlaneLoader *ml = new PlaneLoader(nullptr);
	Model m;
...
float *PlaneLoader::loadFBX(const char* _filepath, Model *_model)
{
	reset();
...
void PlaneLoader::loadMeshData(FbxScene *_fbxScene, Model *_model)
{
...
void PlaneLoader::fetchNodeMesh(FbxNode *_fbxNode, Model *_model)
{
...
void PlaneLoader::fetchVerticesFromMesh(FbxNode *_fbxNode, Model *_model)
{
	//------------------ Step 1 --------------------//
...
void PlaneLoader::fetchMaterials(FbxNode *_fbxNode, Material &_material)
{
...
void PlaneLoader::readMaterial(FbxSurfaceMaterial *_fbxSurfaceMaterial, Material &_material)
{
...
void PlaneLoader::findMaterialTexture(FbxProperty *_fbxProperty, Material &_material)
{
